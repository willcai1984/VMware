...
class vm:
    def __init__(self, host, user, password):
        print '....................VM process begin....................'
        self.host=host
        self.user=user
        self.password=password
        ###object's parameters , need add 'self', be careful this use
        self.ssh_login_command=ssh_host(self.host,self.user,self.password)
        self.spawn_child=self.ssh_login_command.login()
        self.ssh_log_file_open=open('ssh_login.txt', mode='a')
        self.spawn_child.logfile=self.ssh_log_file_open
    def __del__(self):
        self.ssh_log_file_open.close()
        print '....................VM process over....................'
